...
namespace General_App
{
    public partial class frmCustomerDialog : Form
    {
       ...
       public string ItemID;
        ...
        {
            dataGridView1.DataSource = DALAccess.ExecuteDataTable("select * from customer where Name like '%" + textBox1.Text + "%' order by id asc");
        }
        ...
        {
             DataTable dt=DALAccess.ExecuteDataTable("select * from customer order by id asc");
